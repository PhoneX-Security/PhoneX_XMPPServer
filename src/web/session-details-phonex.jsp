...
<% // Get parameters
    ...
    if (request.getParameter("back") != null) {
        response.sendRedirect("session-summary-phonex.jsp");
        return;
    }
    ...
    String unpackedPresence1Tmp = null;
    String unpackedPresence2Tmp = null;
%>
    ...
    <tr>
        ...
        <td>
            <%
                ...
                unpackedPresence1Tmp = null;
                unpackedPresence2Tmp = null;
                String sessIdTmp = UserServicePlugin.getSessionId(currentSess);
                if (origStatus != null) { 
                    PushNotifications.PresencePush pp = UserServicePlugin.readPresencePush(origStatus);
                    if (pp != null){
                        unpackedPresence1Tmp = UserServicePlugin.formatPushPresence(pp);
                        unpackedPresence2Tmp = pp.toString();
                    }
                } 
            ...
            <%
                ...
                if (unpackedPresence1Tmp != null){
           %>
                <br/>
                <%= StringUtils.escapeHTMLTags(unpackedPresence1Tmp) %>
                <a href="javascript:toggle_box('my_box_<%= sessIdTmp %>');">More</a>
                <div id="my_box_<%= sessIdTmp %>" style="display: none;">  
                    <%= StringUtils.escapeHTMLTags(unpackedPresence2Tmp) %> 
                </div>  
            <%  } %> 
        </td>
    </tr>
...
%>
    ...
    <%  int count = 0;
        String linkURL = "session-details-phonex.jsp";
...
<form action="session-details-phonex.jsp">
